...
class version_A(version):
    def __init__(self, parameters):
        ...
        self.molecular_preparation_method = calculations.setup_bonding_and_protonation
        self.prepare_bonds = calculations.setup_bonding
        ...
        # side chain methods
        self.sidechain_interaction_model = calculations.HydrogenBondEnergy
        self.hydrogen_bond_interaction_model = calculations.hydrogen_bond_interaction

        # colomb methods
        self.electrostatic_interaction_model = calculations.electrostatic_interaction
        self.check_coulomb_pair_method = calculations.checkCoulombPair
        self.coulomb_interaction_model = calculations.CoulombEnergy

        #backbone
        self.backbone_interaction_model = calculations.HydrogenBondEnergy
        self.backbone_reorganisation_method = calculations.BackBoneReorganization

        # exception methods
        self.exception_check_method = calculations.checkExceptions
        return
...
class propka30(version):
    def __init__(self, parameters):
        ...
        # atom naming, bonding, and protonation
        self.molecular_preparation_method = calculations.setup_bonding_and_protonation_30_style
