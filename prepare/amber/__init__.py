...
# SKF Aug-18: ionsjc for monovalent, ions234lm di-,tri-,tetra-valent
#   should work with ambertools16 and ambertools18
AMBER_SOLVENT_TYPES = {
...
def init(ff_type, solvent, div_ions, add_ons, mdengine, parmchk_version=2,
    ...
    if ff_type in AMBER_FF_TYPES:
        ...
        ff_cmd = 'addPath %s/dat/leap/prep/oldff\n' % os.environ['AMBERHOME']
        ff_cmd += 'addPath %s/dat/leap/lib/oldff\n' % os.environ['AMBERHOME']
        ff_cmd += 'addPath %s/dat/leap/cmd/oldff\n' % os.environ['AMBERHOME']
